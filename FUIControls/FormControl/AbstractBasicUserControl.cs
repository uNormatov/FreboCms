...
{
    public abstract class AbstractBasicUserControl : AbstractControl, IValidatable
    {
        ...
        public virtual string RequiredErrorMessage
        {
            ...
            set
            {
                ViewState["__required_error_message"] = value;
            }
        }
        ...
        public virtual string RegularExpression
        {
            ...
            set
            {
                ViewState["__regular_expression"] = value;
            }
        }
        ...
        public virtual string RegularExpressionErrorMessage
        {
            ...
            set
            {
                ViewState["__regular_expression_error_message"] = value;
            }
        }
        ...
        public virtual string[] ErrorMessage
        {
            ...
            set
            {
                ViewState["__error_messege"] = value;
            }
        }
        ...
        {
            string[] values = this.Context.Request.Form.AllKeys;
            ...
            if (!string.IsNullOrEmpty(controlid) && this.Context.Request.Form.AllKeys.Contains(controlid))
                return this.Context.Request.Form[controlid];
