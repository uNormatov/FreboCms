<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true"
    CodeBehind="blockaction.aspx.cs" Inherits="FWeb.Administrator.SiteLayout.blockaction" %>
            ...
            <div class="width-40 fltlft">
                <fieldset class="adminform">
                    ...
                    <ul class="adminformlist">
                        ...
                        <li>
                            <asp:Label runat="server" ID="Label3" AssociatedControlID="drlLayout" CssClass="jform_name-lbl"
                                Text="Layout *"></asp:Label>
                            <asp:DropDownList runat="server" ID="drlLayout" CssClass="required" Width="200" DataTextField="Name"
                                DataValueField="Id" OnSelectedIndexChanged="drlLayout_OnSelectedIndexChanged"
                                AutoPostBack="true" />
                            <br />
                        </li>
                        <li>
