<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true"
    CodeBehind="default.aspx.cs" Inherits="FWeb.Administrator.Menus._default" %>
    ...
    <div id="submenu-box">
        <div class="m">
            <ul id="submenu">
                ...
                <li><a href="/administrator/menus/items.aspx">Menu Items</a> </li>
            </ul>
            <div class="clr">
            </div>
        </div>
            ...
            <asp:Repeater runat="server" ID="rptList" OnItemDataBound="RptListItemDataBound">
                ...
                <ItemTemplate>
                    <tr class="row0">
                        ...
                        <td>
                            <a href="/administrator/menus/items.aspx?menuid=<%# DataBinder.Eval(Container.DataItem, "Id") %> ">
