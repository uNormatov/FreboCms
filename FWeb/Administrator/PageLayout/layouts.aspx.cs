    ...
    public partial class layouts : FAdminPage
    {
        ...
        protected override void ParsePost()
        {
            ...
            if (!string.IsNullOrEmpty(action))
            {
                ...
                {
                    Response.Redirect("/administrator/pagelayout/action.aspx?type=entry&categoryid=" + drlCategoryList.SelectedValue);
                }
                else if (action.Equals("edit"))
                {
                    ...
                    if (!string.IsNullOrEmpty(checkboxs))
                    {
                        ...
                        Response.Redirect("/administrator/pagelayout/action.aspx?type=entry&id=" + temps[0]);
                    }
                }
                else
                {
        ...
        protected override void PrintSuccess()
        {
            ...
            builder.Append("<ul>");
            builder.Append("<li>Page Layout successfully saved</li>");
            builder.Append("</ul></dd></dl>");
            ltlMessage.Text = builder.ToString();
        }
    }
