<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true"
    CodeBehind="roleaction.aspx.cs" Inherits="FWeb.Administrator.User.roleaction" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    ...
    <div id="element-box">
        <div class="m">
            ...
            <div class="width-50 fltlft">
                <fieldset class="adminform">
                    <legend>Related Content Type</legend>
                    <ul class="adminformlist">
                        <li>
                            <asp:Label runat="server" ID="Label1" AssociatedControlID="txtName" CssClass="jform_name-lbl"
                                Text="Content Type"></asp:Label>
                            <asp:DropDownList runat="server" ID="drlContentType" />
                        </li>
                        <li>
                            <asp:Label runat="server" ID="Label2" AssociatedControlID="txtUserProfileQuery" CssClass="jform_name-lbl"
                                Text="User Profile Query*"></asp:Label>
                            <asp:TextBox runat="server" ID="txtUserProfileQuery" TextMode="MultiLine" Rows="5"
                                Columns="7"></asp:TextBox>
                        </li>
                    </ul>
                </fieldset>
            </div>
