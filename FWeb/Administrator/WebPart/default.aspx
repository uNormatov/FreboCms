<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true"
    CodeBehind="default.aspx.cs" Inherits="FWeb.Administrator.WebPart._default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>WebPart Categories | Frebo Cms</title>
</asp:Content>
    ...
    <div id="toolbar-box">
        <div class="m">
            ...
            <div class="pagetitle icon-48-sitelayoutmgr">
                <h2>
                    Development: WebPart Categories</h2>
            </div>
        </div>
    </div>
    <div id="submenu-box">
        <div class="m">
            <ul id="submenu">
                <li><a href="" class="active">WebParts Categories</a> </li>
                <li><a href="/administrator/webpart/webparts.aspx">WebParts</a> </li>
            </ul>
            <div class="clr">
            </div>
        </div>
            ...
            <asp:Repeater runat="server" ID="rptList" OnItemDataBound="rptList_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr class="row0">
                        ...
                        <td>
                            <a href="/administrator/webpart/webparts.aspx?categoryid=<%# DataBinder.Eval(Container.DataItem, "Id") %> ">
