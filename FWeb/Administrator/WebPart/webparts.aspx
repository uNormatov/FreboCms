<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true"
    CodeBehind="webparts.aspx.cs" Inherits="FWeb.Administrator.WebPart.webparts" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>WebParts | Frebo Cms</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    ...
    <div id="submenu-box">
        <div class="m">
            <ul id="submenu">
                <li><a href="/administrator/webpart">WebPart Categories</a> </li>
                <li><a href="" class="active">WebParts</a> </li>
            </ul>
            <div class="clr">
            </div>
        </div>
            ...
            <asp:Repeater runat="server" ID="rptList" OnItemDataBound="rptList_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr class="row0">
                        ...
                        <td>
                            <a href="/administrator/webpart/action.aspx?type=entry&id=<%# DataBinder.Eval(Container.DataItem, "Id") %>">
