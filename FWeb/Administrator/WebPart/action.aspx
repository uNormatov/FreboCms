<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true"
    CodeBehind="action.aspx.cs" Inherits="FWeb.Administrator.WebPart.action" %>
    ...
    <div id="element-box">
        <div class="m">
            <div class="width-60 fltlft">
                <fieldset class="adminform">
                    ...
                    <ul class="adminformlist">
                        ...
                        <li>
                            <asp:Label runat="server" ID="Label4" AssociatedControlID="txtFolderPath" CssClass="jform_name-lbl"
                                Text="Folder Path *"></asp:Label>
                            <asp:TextBox runat="server" ID="txtFolderPath" CssClass="required" Width="200"></asp:TextBox>
                        </li>
                    </ul>
                </fieldset>
            </div>
            <div class="width-40 fltlft">
                <fieldset class="adminform">
                    <legend>WebPart Details(Optional)</legend>
                    <ul class="adminformlist">
                        <li>
