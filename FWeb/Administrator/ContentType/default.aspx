<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true"
    CodeBehind="default.aspx.cs" Inherits="FWeb.Administrator.ContentType._default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    ...
    <div id="submenu-box">
        <div class="m">
            <ul id="submenu">
                <li><a href="" class="active">Content Types</a> </li>
                <li><a href="/administrator/contenttype/field.aspx">Fields</a> </li>
                <li><a href="/administrator/contenttype/query.aspx">Queries</a> </li>
                <li><a href="/administrator/contenttype/transformation.aspx">Transformation</a>
                </li>
                <li><a href="/administrator/contenttype/form.aspx">Forms</a> </li>
            </ul>
            <div class="clr">
            </div>
        </div>
            ...
            <asp:Repeater runat="server" ID="rptList" OnItemDataBound="RptListItemDataBound">
                    ...
                    <table class="adminlist">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <asp:LinkButton runat="server" ID="lnkTableName" ToolTip="Click to sort by TableName"
                                        Text="Table Name" OnClick="lnkTableName_OnClick">
                                        <asp:Image runat="server" ID="imgTableName" /></asp:LinkButton>
                                </th>
                                <th>
                                    Description
                                </th>
                ...
                <ItemTemplate>
                    <tr class="row0">
                        ...
                        <td>
                            <a href="/administrator/contenttype/field.aspx?contenttypeid=<%# DataBinder.Eval(Container.DataItem, "Id") %> ">
