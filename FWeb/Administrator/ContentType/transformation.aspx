<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true"
    CodeBehind="transformation.aspx.cs" Inherits="FWeb.Administrator.ContentType.transformation" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Transformations | Frebo Cms</title>
</asp:Content>
        ...
        <div class="m">
            <ul id="submenu">
                ...
                <li><a href="/administrator/contenttype/query.aspx?contenttypeid=<%= ContentTypeId %>">
                    Queries</a> </li>
                <li><a class="active" href="/administrator/contenttype/transformation.aspx?contenttypeid=<%= ContentTypeId %>">
            ...
            <asp:Repeater runat="server" ID="rptList" OnItemDataBound="rptList_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr class="row0">
                        ...
                        <td>
                            <a href="/administrator/contenttype/transformationaction.aspx?type=entry&id=<%# DataBinder.Eval(Container.DataItem, "Id") %>">
