<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuerySelector.aspx.cs"
    Inherits="FWeb.Administrator.Pages.QuerySelector" %>
            ...
            <asp:Repeater runat="server" ID="rptList" OnItemDataBound="rptList_OnItemDataBound">
                ...
                <ItemTemplate>
                    <tr class="row0">
                        ...
                        <td>
                            <a target="_blank" href="/administrator/contenttype/queryaction.aspx?type=entry&id=<%# DataBinder.Eval(Container.DataItem, "Id") %>">
                                edit </a>
                        </td>
                    </tr>
                </ItemTemplate>
