<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true"
    CodeBehind="items.aspx.cs" Inherits="FWeb.Administrator.List.items" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    ...
    <div id="submenu-box">
        <div class="m">
            <ul id="submenu">
                <li><a href="/administrator/list">Lists</a> </li>
                <li><a class="active" href="">List Items</a> </li>
            </ul>
            <div class="clr">
            </div>
        </div>
            ...
            <asp:Repeater runat="server" ID="rptList" OnItemDataBound="rptList_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr class="row0">
                        ...
                        <td>
                            <a href="/administrator/list/itemaction.aspx?type=entry&id=<%# DataBinder.Eval(Container.DataItem, "Id") %>">
