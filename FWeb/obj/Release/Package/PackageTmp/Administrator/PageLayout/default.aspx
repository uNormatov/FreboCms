<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true"
    CodeBehind="Default.aspx.cs" Inherits="FWeb.Administrator.SiteLayout.Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Page Layout Categories | Frebo Cms</title>
</asp:Content>
    ...
    <div id="toolbar-box">
        <div class="m">
            ...
            <div class="pagetitle icon-48-sitelayoutmgr">
                <h2>
                    Page Layout Manager: Categories</h2>
            </div>
        </div>
    </div>
    <div id="submenu-box">
        <div class="m">
            <ul id="submenu">
                <li><a href="" class="active">Layout Categories</a> </li>
                <li><a href="/administrator/pagelayout/layouts.aspx">Page Layouts</a> </li>
            ...
            <asp:Repeater runat="server" ID="rptList" OnItemDataBound="RptListItemDataBound">
                ...
                <ItemTemplate>
                    <tr class="row0">
                        ...
                        <td>
                            <a href="/administrator/pagelayout/layouts.aspx?categoryid=<%# DataBinder.Eval(Container.DataItem, "Id") %> ">
