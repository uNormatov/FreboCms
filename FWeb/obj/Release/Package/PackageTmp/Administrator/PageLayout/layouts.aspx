<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true"
    CodeBehind="layouts.aspx.cs" Inherits="FWeb.Administrator.PageLayout.layouts" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Page Layouts | Frebo Cms</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    ...
    <div id="submenu-box">
        <div class="m">
            <ul id="submenu">
                <li><a href="/administrator/pagelayout">Layout Categories</a> </li>
                <li><a href="" class="active">Page Layouts</a> </li>
                <li><a href="/administrator/pagelayout/blocks.aspx">Blocks</a> </li>
            </ul>
            <div class="clr">
            </div>
        </div>
        ...
        <div class="m">
            ...
            <fieldset id="filter-bar">
                ...
                <div class="filter-select fltrt">
                    <asp:DropDownList runat="server" ID="drlCategoryList" AutoPostBack="true" OnSelectedIndexChanged="drlCategoryList_SelectedIndexChanged"
            ...
            <asp:Repeater runat="server" ID="rptList" OnItemDataBound="rptList_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr class="row0">
                        ...
                        <td>
                            <a href="/administrator/pagelayout/blocks.aspx?layoutid=<%# DataBinder.Eval(Container.DataItem, "Id") %> ">
                ...
                <AlternatingItemTemplate>
                    <tr class="row1">
                        <td class="center">
                            <input type="checkbox" title="Checkbox for row <%# DataBinder.Eval(Container.DataItem, "Name") %>"
                                value="<%# DataBinder.Eval(Container.DataItem, "Id") %>" onclick="Frebo.checked(this.checked);"
                                name="chbxRow" id="chbxRow">
                        </td>
                        <td>
                            <a href="/administrator/pagelayout/blocks.aspx?layoutid=<%# DataBinder.Eval(Container.DataItem, "Id") %> ">
                                <%# DataBinder.Eval(Container.DataItem, "Name") %>
