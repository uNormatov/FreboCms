<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true"
    CodeBehind="blocks.aspx.cs" Inherits="FWeb.Administrator.PageLayout.blocks" %>

<%@ Import Namespace="FUIControls.Settings" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Page Layouts Blocks |
            ...
            <asp:Repeater runat="server" ID="rptList" OnItemDataBound="rptList_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr class="row0">
                        ...
                        <td>
                            <a href="/administrator/pagelayout/blockaction.aspx?type=entry&layoutid=<%# LayoutId %>>&id=<%# DataBinder.Eval(Container.DataItem, "LayoutNBlockId") %>">
