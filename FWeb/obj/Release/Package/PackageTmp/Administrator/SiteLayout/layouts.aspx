<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true"
    CodeBehind="layouts.aspx.cs" Inherits="FWeb.Administrator.SiteLayout.layouts" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Site Layouts | Frebo Cms</title>
</asp:Content>
    ...
    <div id="submenu-box">
        <div class="m">
            <ul id="submenu">
                ...
                <li><a href="" class="active">Site Layouts</a> </li>
                 <li><a href="/administrator/sitelayout/blocks.aspx">Blocks</a> </li>
            </ul>
            <div class="clr">
            </div>
        </div>
        ...
        <div class="m">
            ...
            <fieldset id="filter-bar">
                ...
                <div class="filter-select fltrt">
                    <asp:DropDownList runat="server" ID="drlCategoryList" AutoPostBack="true" OnSelectedIndexChanged="DrlCategoryListSelectedIndexChanged"
            ...
            <asp:Repeater runat="server" ID="rptList" OnItemDataBound="RptListItemDataBound">
                ...
                <ItemTemplate>
                    <tr class="row0">
                        ...
                        <td>
                            <a href="/administrator/sitelayout/blocks.aspx?layoutid=<%# DataBinder.Eval(Container.DataItem, "Id") %> ">
