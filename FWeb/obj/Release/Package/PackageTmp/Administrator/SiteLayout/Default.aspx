<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true"
    CodeBehind="Default.aspx.cs" Inherits="FWeb.Administrator.PageLayout.Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Site Layout Categories | Frebo Cms</title>
</asp:Content>
    ...
    <div id="toolbar-box">
        <div class="m">
            ...
            <div class="pagetitle icon-48-sitelayoutmgr">
                <h2>
                    Designer: Site Layout Categories</h2>
            </div>
        </div>
    </div>
    <div id="submenu-box">
            ...
            <asp:Repeater runat="server" ID="rptList" OnItemDataBound="rptList_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr class="row0">
                        ...
                        <td>
                            <a href="/administrator/sitelayout/layouts.aspx?categoryid=<%# DataBinder.Eval(Container.DataItem, "Id") %> ">
