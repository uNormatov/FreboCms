<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true"
    CodeBehind="action.aspx.cs" Inherits="FWeb.Administrator.SiteLayout.action" ValidateRequest="false" %>
                ...
                <fieldset class="adminform">
                    ...
                    <ul class="adminformlist">
                        ...
                        <li>
                            ...
                            <asp:DropDownList runat="server" ID="drlCategory" CssClass="required" Width="200" DataTextField="Name"
                                DataValueField="Id" />
                            <br />
                        </li>
                        <li>
                            <asp:TextBox TextMode="MultiLine" Rows="1" ID="txtDocType" runat="server" Width="98%"
                                onkeydown="return TabKeyTextArea(event, 'ctl00_MainContent_txtDocType', '    ');">
                            </asp:TextBox><br />
                            <asp:Literal ID="ltrHead" runat="server"></asp:Literal>
                            <asp:TextBox TextMode="MultiLine" Rows="6" ID="txtCSSSheet" runat="server" Width="98%" 
                                onkeydown="return TabKeyTextArea(event, 'ctl00_MainContent_txtCSSSheet', '    ');">
                            </asp:TextBox><br />
                            <asp:Literal ID="ltrHeadClose" runat="server"></asp:Literal>
                            <asp:Literal ID="ltrBody" runat="server"></asp:Literal>
                            <asp:TextBox ID="txtBodyInit" runat="server" Width="50%" >
                            </asp:TextBox>
                            <asp:Literal ID="ltrBodyTagClose" runat="server"></asp:Literal><br />
                            <asp:TextBox TextMode="MultiLine" Rows="40" ID="txtBodyContent" runat="server" Width="98%" Height="400"
                                onkeydown="return TabKeyTextArea(event, 'ctl00_MainContent_txtBodyContent', '    ');" CssClass="required"></asp:TextBox>
                            <asp:Literal ID="ltrBodyClose" runat="server"></asp:Literal>
                        </li>
                    </ul>
                </fieldset>
            </div>
