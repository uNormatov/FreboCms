<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true"
    CodeBehind="form.aspx.cs" Inherits="FWeb.Administrator.ContentType.form" %>
<%@ Import Namespace="FUIControls.Settings" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Forms | <%= CoreSettings.CurrentSite.Name%></title>
</asp:Content>
        ...
        <div class="m">
            <ul id="submenu">
                ...
                <li><a href="/administrator/contenttype/transformation.aspx?contenttypeid=<%= ContentTypeId %>">
                    Transformation</a> </li>
                <li><a class="active" href="/administrator/contenttype/form.aspx?contenttypeid=<%= ContentTypeId %>">
                    Forms</a> </li>
            </ul>
            <div class="clr">
            </div>
            ...
            <asp:Repeater runat="server" ID="rptList" OnItemDataBound="rptList_OnItemDataBound">
                            ...
                            <tr>
                                ...
                                <th>
                                    <asp:LinkButton runat="server" ID="lnkSortByName" ToolTip="Click to sort by Name"
                                        Text="Display Name" OnClick="lnkSortByName_OnClick">
                ...
                <ItemTemplate>
                    <tr class="row0">
                        ...
                        <td>
                            <a href="/administrator/contenttype/formaction.aspx?type=entry&id=<%# DataBinder.Eval(Container.DataItem, "Id") %>">
